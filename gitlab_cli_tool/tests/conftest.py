...
from gitlab_cli_tool.cli_api import GitlabAPI, GitLabDataFilter, Runner
...
JOBS_WITH_RUNNERS = [
    {"job_id": 1, "runner": {"id": 278}},
    {"job_id": 2, "runner": {"id": 279}},
    {"job_id": 3, "runner": {"id": 278}},
    {"job_id": 4, "runner": {"id": 280}},
...
URLS_FOR_PAGINATION = [
    "https://gitlab.server.com/api/v4/runners/all?per_page=40",
